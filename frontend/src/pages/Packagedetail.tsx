...
function PackageDetail() {
    ...
    },[totalcloth,totalAddOn,selectedCloth,selectedAddOn,image]
    )
    useEffect(()=>{
        GetImage()
    ...
    return (
        <div >
            ...
            <Package id= {id as string} priceSelectedItemsChange={setTotalcloth} SelectedCloth={setSelectedCloth}/>
            <p className="text-2xl my-10 text-center">บริการเสริม</p>
            <AddOn id={id as string} priceSelectedAddOnChange ={setTotalAddOn} SelectedAddOn={setSelectedAddOn} />
            <Calculate cloth ={totalcloth} addon = {totalAddOn} selectedAddon={selectedAddOn}  selectedCloth={selectedCloth}/>
            <div>
